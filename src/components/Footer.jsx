  ...
  return (
    <>
      <style>{`
        ...
        .pill-github:hover svg { color: #00FFC6; }
        ...
        /* Adjusted layout alignment to fix the stretching issue */
        .connect-group {
          display: flex;
          flex-direction: column;
          gap: 16px;
          align-items: flex-start; /* Changed from flex-end for cleaner alignment */
          width: 100%;
          max-width: 340px;
        }
        .social-row {
        ...
        <div className="footer-layout">
          ...
          <div className="connect-group">
            ...
            <div className="social-row">
              ...
              <Link to="/coming-soon" className="premium-pill pill-github" style={{ flex: 1 }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
